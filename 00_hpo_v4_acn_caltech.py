...
# ==============================================================================
# 4. Optuna Study Execution & Result Archiving
# ==============================================================================
if __name__ == '__main__':
    ...
    for key, val in study.best_params.items():
        print(f"  - {key:<25}: {val}")
    print(f"  - {'best_val_loss':<25}: {study.best_value:.8f}")
    print("=" * 65)

    output_json = "00_hpo_v4_acn_caltech_best_params.json"
    ...
    with open(archive_json, "w", encoding="utf-8") as f:
        json.dump(best_data, f, indent=4)
    print(f"Archived to {archive_json}")
