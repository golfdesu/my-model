...
| 6 | `04_tfm_ifm_pytorch` | Transformer | 5.1754 ± 0.1009 | 7.9190 ± 0.1008 | 60.78% ± 1.19% | 12.4838 | 0.6727 | 654,337 | 62.3s |
| 7 | `24_nhits_baseline_pytorch` | Basis Expansion | 5.2916 ± 0.0827 | 7.7747 ± 0.1053 | 62.14% ± 0.97% | 12.9767 | 0.6845 | 2,308,530 | 27.5s |
| 8 | `18_lightgbm_baseline` | Tree-based GBDT | 5.3865 ± 0.0059 | 8.1150 ± 0.0070 | 63.26% ± 0.07% | 14.7259 | 0.6563 | 48,000 | 196.4s |
...
| 20 | `06_tfm_ptst_pytorch` | Transformer | 5.7672 ± 0.0432 | 9.2539 ± 0.0509 | 67.73% ± 0.51% | 18.7351 | 0.5531 | 542,056 | 166.4s |
| 21 | `16_s4d_baseline_pytorch` | State Space Model | 5.7690 ± 0.1409 | 8.3191 ± 0.1640 | 67.75% ± 1.65% | 13.4052 | 0.6387 | 27,984 | 19.4s |
| 22 | `14_powermamba_baseline_pytorch` | State Space Model | 5.7845 ± 0.1200 | 8.2071 ± 0.1632 | 67.93% ± 1.41% | 14.2565 | 0.6483 | 45,360 | 107.4s |
| 23 | `30_nstransformer_baseline_pytorch` | Transformer (NS-Tfm) | 5.8956 ± 0.1437 | 8.6152 ± 0.1732 | 69.24% ± 1.69% | 15.2207 | 0.6125 | 113,873 | 24.2s |
...
| 28 | `05_tfm_afm_pytorch` | Transformer | 6.1093 ± 0.2615 | 8.8067 ± 0.3654 | 71.75% ± 3.07% | 14.2751 | 0.5945 | 350,210 | 172.3s |
| 29 | `12_nlinear_baseline_pytorch` | Linear & Decomp | 6.2466 ± 0.0036 | 10.4387 ± 0.0011 | 73.36% ± 0.04% | 21.3976 | 0.4313 | 4,656 | 30.3s |
| 30 | `11_dlinear_baseline_pytorch` | Linear & Decomp | 6.9656 ± 0.1071 | 10.4281 ± 0.0434 | 81.80% ± 1.26% | 19.6542 | 0.4325 | 9,312 | 24.6s |
| 31 | `25_tide_baseline_pytorch` | Linear / Dense MLP | 6.9962 ± 0.0631 | 10.4550 ± 0.0326 | 82.16% ± 0.74% | 19.4354 | 0.4295 | 1,833,396 | 16.3s |
