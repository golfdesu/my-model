...
def run_benchmark():
    ...
    for seed_idx, SEED in enumerate(SEEDS, 1):
        ...
        # Build Model
        model = InformerModel(lookback=LOOKBACK, num_features=X_train_scaled.shape[1], horizon=HORIZON, d_model=128, num_heads=8, d_ff=512, num_layers=2, dropout_rate=0.1).to(device)
