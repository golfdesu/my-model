...
# ==============================================================================
# 1. Dataset Loading & Preprocessing (ACN Caltech without Weather)
# ==============================================================================
...
# Weather ablation: remove all weather variables while retaining load and calendar features.
...
exo_indices = None
endo_indices = list(range(len(cols)))
...
output_archive_dir = "outputs/acn_caltech_no_weather/00_tfm_custom_v4"
results_data = {
