...
output_md_filename = "14_tfm_timesnet_pytorch.md"
...
all_seed_metrics = []
md_lines = [
    f"# TimesNet (ICLR 2023) — ACN Caltech EV Charging Forecast\n",
...
# ---------------------------------------------------------
print(f"\n{'='*70}")
print(f"FINAL SUMMARY ACROSS {len(SEEDS)} SEEDS — TimesNet")
print(f"{'='*70}")
