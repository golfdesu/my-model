...
# ==============================================================================
# Multi-Seed Benchmark for Model 31: SCINet
...
MODEL_NAME = "31_scinet_baseline_pytorch"
...
CONFIG = {
    ...
    "kernel_size": 3,
    "dropout": 0.2,
    "learning_rate": 0.00040954812969068986,
    "weight_decay": 0.00015224452150288816,
    "batch_size": 64,
    "epochs": 200,
    "patience": 15}
