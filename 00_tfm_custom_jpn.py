...
EEO_ORTHOGONAL_REG        = 5.284781856026136e-06

OUTPUT_STEM = "00_tfm_custom_jpn"
...
output_archive_dir   = "outputs/acn_jpn/00_tfm_custom_pytorch"
...
print(f"Starting Automated {len(SEEDS)}-Seed Loop for Model 00 (JPN with Weather)...")
...
print(f"\n======================================================================")
print(f"FINAL SUMMARY ACROSS {len(SEEDS)} SEEDS — 00_tfm_custom_pytorch (JPN with Weather)")
print(f"======================================================================")
summary_dict = {}
