...
# # 00_tfm_custom_caltech_no_weather.py
# Model 00 (Inverted Variate-Centric Custom Transformer + Orthogonal Regularization)
# Target Dataset: ACN-Caltech without Weather (acn_caltech_ready2.csv)
# 10-Seed Multi-Seed Production Benchmark ([42, 123, 456, ..., 9999])
# Parameters: Caltech Full HPO Selected Configuration
...
# ==============================================================================
# 1. Dataset Loading & Preprocessing (Caltech without Weather)
# ==============================================================================
...
class InvertedCustomTransformer(nn.Module):
    ...
    def __init__(self, lookback, num_variates, horizon, target_ch_idx,
                 d_model=128, num_heads=8, d_ff=512, num_layers=3, dropout_rate=0.1,
        ...
        # Dual-Context Readout Projection Head: Target Token (d_model) + Global Variate Mean (d_model) -> Horizon (48)
    ...
    def forward(self, x):
        # x: [Batch, Lookback, Variates] -> Transpose to [Batch, Variates, Lookback]
...
# Selected Hyperparameters from Caltech Full HPO
D_MODEL             = 128
NUM_HEADS           = 8
D_FF                = 512
NUM_LAYERS          = 3
...
OUTPUT_STEM = "00_tfm_custom_caltech_no_weather"
...
output_archive_dir   = "outputs/acn_caltech_no_weather/00_tfm_custom_pytorch"
...
print(f"Starting Automated {len(SEEDS)}-Seed Loop for Model 00 (Caltech No Weather)...")
...
print(f"\n======================================================================")
print(f"FINAL SUMMARY ACROSS {len(SEEDS)} SEEDS — 00_tfm_custom_pytorch (Caltech No Weather)")
print(f"======================================================================")
summary_dict = {}
